...
class Application(Frame):
    ...
    def createDist(self):
        self.distWidget = Label(self.top_left, fg='white', background='black', justify='left', font=('Courier', 14, 'bold'))
...
def updateTravel():
    ...
    app.distWidget.after(450000, updateTravel)
